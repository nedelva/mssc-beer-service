...
public class BeerController {
    ...
    public ResponseEntity<BeerDto> getBeerByUpc(@PathVariable("upc") String upc, @RequestParam(value = "showInventoryOnHand", defaultValue = "false") boolean showInventoryOnHand) {
